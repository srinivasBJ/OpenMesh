...
NODE_TYPES: dict[str, NodeType] = {
    ...
    "service": NodeType("service", "Service", "A long-lived service or runtime component.", "services", COMMON_METADATA + ("graph", "endpoint")),
    "framework": NodeType("framework", "Framework", "An observed agent framework.", "frameworks", COMMON_METADATA),
    "mcp_server": NodeType("mcp_server", "MCP Server", "An observed Model Context Protocol server.", "services", COMMON_METADATA + ("endpoint", "transport")),
    "capability": NodeType("capability", "Capability", "A capability exposed by a service or tool.", "capabilities", COMMON_METADATA),
